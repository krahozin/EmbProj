...
void setup() {
  ...
  Serial.println("  find:North     - Rotate car to face North (0 degrees)");
}
...
void readCommandFromSerial() {
  if (Serial.available() > 0) {
    ...
    if (command.startsWith("dist:")) {
    ...
    else if (command.startsWith("find:North")) {
      Serial.println("========================================");
      Serial.println(">> COMMAND: find:North");
      Serial.println(">> Finding North (heading to 0 degrees)");

      // Set target heading to 0 degrees (North)
      targetHeading = 0.0f;
      Serial.print(">> Target Heading: ");
      Serial.print(targetHeading);
      ...
      Serial.println("Invalid command! Use 'dist:<number>', 'deg:<number>', 'lcd:<message>', or 'find:North'");
    }
  }
}
